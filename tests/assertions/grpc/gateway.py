...
from contracts.services.cards.card_pb2 import CardStatus, CardType, CardPaymentSystem
...
def assert_get_user_details_response(actual: GetUserDetailsResponse, expected: GetUserDetailsResponse) -> None:
...
def assert_get_account_details_response(actual: GetAccountDetailsResponse, expected: GetAccountDetailsResponse) -> None:
    logger.info("Check get accounts details response")
...
def assert_get_user_details_response_user_with_active_credit_card_account(actual: GetUserDetailsResponse) -> None:
